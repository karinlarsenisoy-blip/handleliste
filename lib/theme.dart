...
/// The "Fersk" visual direction: dagligvare-green as the primary color, a
/// coral savings-accent reserved for the app's one big "go do this" moment
/// (see [savingsAccent] and where it's used), and a friendly display face
/// paired with a calm body face. Deliberately doesn't yet touch how price
/// figures/list rows are set (the "kvittering" receipt-line styling) — that
/// part is tied to the Handletur/trip screens, which are still due to
/// change once real routing (Fase B) lands, so it stays a separate pass.
class AppTheme {
  AppTheme._();

  static const _primary = Color(0xFF2F6B4F);
  static const _onPrimary = Color(0xFFF5F8F1);
  static const _background = Color(0xFFF3F5EC);
